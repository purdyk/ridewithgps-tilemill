...
#roads_low::outline[zoom>=5][zoom<7] {
...
#roads_med::outline[zoom>=7][zoom<=10] {
  [type='motorway'],
  [type='motorway_link'] {
...
#bridge[render='1_outline'][zoom>=11][zoom<=20]{
  ...
  [zoom=12] {
    ...
    [stylegroup='noauto']   { line-width: 0; }
    [stylegroup='railway']  { line-width: 0; }
    [stylegroup='foot'] 	{ line-width: 0.5; }
    [stylegroup='cycle'] 	{ line-width: 0.5; }
  }
  [zoom=13] {
